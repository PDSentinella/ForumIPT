...
const UserCard = (props) => {
  const [userCard,setUserCard] = useState(props.user)
  ...
  return (
    <div className='flex h-36 w-full  mx-4 py-4  justify-center'>            
            ...
            <           img  className="w-20 h-20 sm:w-28 sm:h-28" src ={`${userCard.img}`}></img>
                    </div>
                    ...
                    {/*<div className='relative bottom-4 w-0 right-11 sm:static sm:w-auto'>
