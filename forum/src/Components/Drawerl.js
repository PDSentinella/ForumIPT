    ...
    return (
      <div className='flex flex-col  items-center pt-2 overflow-y-auto h-full '>
        <div className='flex cursor-pointer pb-2 '>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none"  PencilIcon color='#EEF4F8' viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={`w-6 h-6 self-center ${!props.open && 'hidden'} ${open&&'rotate-180'} `} onClick={()=>setOpen(!open)}>
