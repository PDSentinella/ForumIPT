    ...
    const [open, setOpen] = useState(false);
      ...
      return (
        <div className={`${open &&'w-0 '} max-sm:hidden sm:w-16  flex `} onMouseOver={(e) => {setOpen(true)}} > {/*${open &&'w-0 '} sm:w-16*/}{/*w-0 sm:w-16*/}
            <div className={`${open ?'w-72 absolute': 'w-0 sm:w-16  '} max-sm:hidden absolute duration-300 h-full bg-ipt overflow-y-auto  `} onMouseOver={(e) => {setOpen(true)}} onMouseLeave={()=>{setOpen(false)}}>
                <div className={`flex  cursor-pointer items-center justify-center w-full gap-x-6 pt-8`}>
                    ...
                    <h1 className={`${!open && 'hidden'} duration-500 text-4xl text-alice-blue font-bold`}>FORUM</h1>  
                </div>
                ...
                <div className={`flex flex-col flex-1 justify-center gap-y-6 pt-8 ${!open ?'items-center w-full ':'items-start ml-14 w-62'}`}>
                    <div className={`flex gap-x-2 justify-center cursor-pointer `}>
                        <div className={` flex rounded items-center justify-center bg-alice-blue w-6 h-6 `}>
                        ...
                        <h1 className={`${!open&&'hidden'}  text-alice-blue`}>Home</h1>
                    </div> 
                    {/*Home*/}
                    ...
                    <div className='flex gap-x-2 items-center cursor-pointer'>
                        ...
                        <h1 className={`${!open&&'hidden'} text-alice-blue`}>Your treads</h1>
                    </div>                     
                    {/*Your treads*/}
                    <div className='flex gap-x-2 items-center cursor-pointer '>
                        <div className=' flex rounded items-center justify-center bg-alice-blue w-6 h-6 '>
                        ...
                        <h1 className={`${!open&&'hidden'} text-alice-blue`}>Saved</h1>
                    </div>  
                    {/*Saved*/}
                    {/*Drawerl*/}
                ...
                <button className={` flex gap-2 p-3 place-self-end self-center mt-8 ml-14 bg-alice-blue text-ipt rounded ${!open && 'hidden'}`}>
