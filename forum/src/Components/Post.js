...
function Post(props){
    ...
    return ( 
    <div className={`flex flex-initial flex-col gap-4 pt-4 bg-white mt-2 p-2  w-full h-auto rounded-md `}>
            {/*titulo*/}
            ...
            <div className='flex flex-row '>{/*flex-col sm:!flex-row gap-y-3*/}
                ...
                <div className='flex w-full gap-1'>
                        {/*save icon*/}
                        <div  className='flex p-1 justify-center items-center cursor-pointer '>
                        ...
                        <button className='flex p-1 justify-center items-center bg-pale_purple rounded-full'>
                            ...
                            <h3 className='text-ipt text-xs mr-1'>Comment</h3>
                        </button>
